...
echo "<script> window.open('sell_interface_login.php?not_seller=You are not a seller !','_self') </script>";
...
?>
   ...
   <table width="770"  align="left"  bgcolor="skyblue">
...
<tr align="center">
	...
	<td><br><a href="test.php?edit_pro=<?php echo $pro_id; ?>">Edit</a></td>
