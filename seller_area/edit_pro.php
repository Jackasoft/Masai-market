...
echo "<script> window.open('test.php?not_admin=You are not a admin !','_self') </script>";
...
<body bgcolor="skyblue">
   ...
   <form  method="post" enctype="multipart/form-data"> <!-- entype= multitype means we will receive data in multiple formats like images or may be videos -->
   
   <table align="center" width="900" height="622" border="10" bgcolor="#187eae">
 ...
 <tr>
 	...
 	<td>
 		<input type="text" name="product_desc" cols="80" rows="10" ><?php echo $pro_desc;?></input>
 	</td>
...
<?php
 ...
 if(isset($_POST['update_product']))
  ...
  echo "<script> window.open('test.php?view_product','self')</script>"; 
  }
