...
<body bgcolor="brown">
   ...
   <table align="left" width="770" height="622" border="10" bgcolor="#187eae">
 ...
 <tr>
 	...
 	<td>
 		<input type="text" name="product_desc" cols="80" rows="10"></input type="text">
 	</td>
...
<?php
 ...
 if(isset($_POST['insert_post']))
  ...
  echo "<script> window.open('test.php?insert_product','self')</script>";
